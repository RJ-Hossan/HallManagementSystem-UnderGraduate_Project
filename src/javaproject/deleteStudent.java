...
public class deleteStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Dept. Name", "Room No", "Block No", "Address"
            }
        ) {
        ...
        jLabel8.setText("*You can resize the column to see the full details.");

        jLabel9.setBackground(new java.awt.Color(255, 255, 255));
        jLabel9.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel9.setText("Please enter the corresponding student ID :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            tm.setRowCount(0);
            while(rs.next()){
                Object obj[] = {rs.getInt("ID"), rs.getString("studentName"), rs.getString("deptName"), rs.getString("Room"), rs.getString("Block"), rs.getString("Address")};
                tm.addRow(obj);
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "Succesfully deleted the details. To see the update info, kindly click the Refresh button.");
