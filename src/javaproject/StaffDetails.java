...
public class StaffDetails extends javax.swing.JFrame {
    ...
    public StaffDetails() throws SQLException {
        initComponents();
        ...
        try {
            ...
            tm1.setRowCount(0);
            while(rs.next()){
                Object obj[] = {rs.getInt("SL"), rs.getInt("ID"), rs.getString("Name"), rs.getString("Gender"), rs.getString("Designation")};
                tm1.addRow(obj);
            }
        } 
    ...
    private void initComponents() {
        ...
        jTabbedPane2.setForeground(new java.awt.Color(80, 135, 185));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SL No", "Staff's ID", "Staff's Name", "Staff's Gender", "Staff's Designation"
            }
        ) {
        ...
        jLabel18.setText("*You can resize the column to see the details");
        ...
        jPanel9.setBackground(new java.awt.Color(80, 135, 185));
        ...
        jCheckBox1.setForeground(new java.awt.Color(80, 135, 185));
        ...
        jCheckBox2.setForeground(new java.awt.Color(80, 135, 185));
        ...
        jTabbedPane2.addTab("Add Staff", jPanel5);
        ...
        jPanel12.setBackground(new java.awt.Color(80, 135, 185));
        ...
        jTextField8.setForeground(new java.awt.Color(80, 135, 185));
        ...
        jCheckBox3.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        jCheckBox3.setForeground(new java.awt.Color(80, 135, 185));
        ...
        jCheckBox4.setFont(new java.awt.Font("Cambria", 1, 14)); // NOI18N
        jCheckBox4.setForeground(new java.awt.Color(80, 135, 185));
        ...
        jTabbedPane2.addTab("Update Details", jPanel6);
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SL No", "Staff's ID", "Staff's Name", "Staff's Gender", "Designation"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false
        ...
        jLabel17.setText("Enter the Manager ID");
        ...
        jTextField7.setForeground(new java.awt.Color(80, 135, 185));
        ...
        jButton6.setForeground(new java.awt.Color(80, 135, 185));
        ...
        jTabbedPane2.addTab("Delete Staff Details", jPanel7);

        jPanel10.setBackground(new java.awt.Color(80, 135, 185));
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        try {
            // TODO add your handling code here:
            StaffDetails db = new StaffDetails();
            db.setVisible(true);
            this.dispose();
        } catch (SQLException ex) {
            Logger.getLogger(StaffDetails.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            if(verifyFields1()){
                String query = "update staffdetails set ID=?, Name=?, Gender=?, Designation=? WHERE ID=?";
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            if(verifyFields()){
                String query = "INSERT INTO staffdetails values(?,?,?,?,?)";
                ...
                pst.execute();
                JOptionPane.showMessageDialog(null, "Corresponding staff's details inserted into the corresponding room.");
    ...
    public boolean verifyFields(){
        ...
        if(field1.trim().equals("") || field2.trim().equals("") || field3.trim().equals("")){
    ...
    public boolean verifyFields1(){
        String field1 = jTextField4.getText();
        String field2 = jTextField5.getText();
        String field3 = jTextField8.getText();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        try {
            String query = "DELETE FROM staffdetails WHERE ID=?";
            pst = con.prepareStatement(query);
