...
public class profileUpdateUser extends javax.swing.JFrame {
  
    Connection con = null;
    PreparedStatement pst = null;
    public profileUpdateUser() throws SQLException {
    ...
    public boolean verifyFields(){
        ...
        if(f_name.trim().equals("") || u_name.trim().equals("") || dob.trim().equals("") || address.trim().equals("") || gen.trim().equals("") || pass.trim().equals("") || c_pass.trim().equals("")){
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        try {
            ...
            Logger.getLogger(profileUpdateUser.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            if(verifyFields()){
                String query = "update register set ID=?, Name=?, UserName=?, ContactNo=?, Gender=?, DoB=?, Age=?, Address=?, Password=? WHERE ID=?";
                ...
                pst.setString(8, jFormattedTextField1.getText());
                pst.setString(9, String.valueOf(jPasswordField1.getPassword()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(profileUpdateUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new profileUpdateUser().setVisible(true);
