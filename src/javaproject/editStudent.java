...
public class editStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons8_back_25px_1.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons8_cancel_25px.png"))); // NOI18N
        ...
        jPanel2.setBackground(new java.awt.Color(80, 135, 155));
        jPanel2.setPreferredSize(new java.awt.Dimension(0, 40));

        jLabel3.setFont(new java.awt.Font("Georgia", 1, 8)); // NOI18N
        ...
        jLabel4.setForeground(new java.awt.Color(80, 135, 155));
        ...
        jTextField5.setForeground(new java.awt.Color(80, 135, 185));
        ...
        jTextField6.setForeground(new java.awt.Color(80, 135, 185));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            if(verifyFields()){
                String query = "update studentdetails set studentName=?, deptName=?, Room=?, Block=?, Address=? WHERE ID=?";
                ...
                pst.execute();
                JOptionPane.showMessageDialog(this, "Succesfully edited the details.");
    ...
    public boolean verifyFields(){
        ...
        if(field1.trim().equals("") || field2.trim().equals("") || field3.trim().equals("") || field4.trim().equals("") || field5.trim().equals("") || field6.trim().equals("")){
